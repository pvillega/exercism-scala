...
class PrimeFactorsTest extends FlatSpec with Matchers {
  ...
  it should "2 is prime" in {
    PrimeFactors.isPrime(2L) should be(true)
  }

  it should "3 is prime" in {
    PrimeFactors.isPrime(3L) should be(true)
  }

  it should "5 is prime" in {
    PrimeFactors.isPrime(5L) should be(true)
  }

  it should "13 is prime" in {
    PrimeFactors.isPrime(13L) should be(true)
  }

  it should "14 is not prime" in {
    PrimeFactors.isPrime(14L) should be(false)
  }
}
